...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gf-kernel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11675&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gf-kernel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gf-kernel` can be installed with:

```
conda install gf-kernel
```

It is possible to list all of the versions of `gf-kernel` available on your platform with:
